<template>
    <div>
        ...
        <b-container>
                    ...
                    <b-row>
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Category" label-for="item-category">
                                <b-form-select id="item-category" v-model="item.category" :options="categories"
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Item Name" label-for="item-name">
                                <b-form-input id="item-name" v-model="item.name" placeholder="Enter item name"
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Price (₹)" label-for="item-price">
                                <b-form-input id="item-price" v-model.number="item.price" type="number" min="0"
                                    placeholder="Enter price" required></b-form-input>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Discount (%)" label-for="item-discount">
                                <b-form-input id="item-discount" v-model.number="item.discount" type="number" min="0"
                                    max="50" placeholder="Enter discount percentage"></b-form-input>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Rating" label-for="item-rating">
                                <b-form-input id="item-rating" v-model.number="item.rating" type="number" min="0"
                                    max="5" step="0.1" placeholder="Enter rating out of 5"></b-form-input>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Image URL" label-for="item-img">
                                <b-form-input id="item-img" v-model="item.img"
                        ...
                        <b-col cols="12" lg="6" sm="12">
                            <b-form-group label="Description" label-for="item-description">
                                <b-form-textarea id="item-description" v-model="item.description"
                                    placeholder="Enter item description" rows="2"></b-form-textarea>
                            </b-form-group>
                        </b-col>
                    </b-row>
            ...
            <h2>Added Items</h2>
            <b-row>
                <b-col v-for="(item, index) in items" :key="index" cols="12" md="6" lg="3" class="my-4">
                    <b-card :title="item.name" :img-src="item.img" img-alt="Product image" img-top
                        class="custom-card shadow-sm">
                        <b-button @click="removeItem(index)" variant="danger" size="sm" class="position-absolute"
...
export default {
    ...
    methods: {
        addItem() {
            ...
            this.$bvToast.toast(`Added "${this.item.name}" with price ₹${this.item.price} successfully!`, {
                title: 'Success',
                variant: 'success',
                solid: true,
                autoHideDelay: 3000,
